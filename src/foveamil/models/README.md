...
`FoveaMIL(in_feat_dim, hidden_feat_dim=256, out_feat_dim=512, dropout=None, k_sample=12, n_cls=3, num_layers=4, topk_method="perturbed", topk_kwargs=None, aux_norm="softmax", aux_norm_kwargs=None, selector="topk", selector_kwargs=None, fusion="sum", aggregator="abmil", aggregator_kwargs=None, instance_loss=False, inst_k=8, inst_subtyping=True)`．
